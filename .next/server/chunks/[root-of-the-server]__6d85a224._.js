module.exports=[918622,(e,t,r)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},556704,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},832319,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},324725,(e,t,r)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},224361,(e,t,r)=>{t.exports=e.x("util",()=>require("util"))},518041,e=>{"use strict";var t=e.i(926046);let r=new t.default.Schema({name:{type:String,required:[!0,"Branch name is required"],trim:!0},code:{type:String,required:[!0,"Branch code is required"],unique:!0,uppercase:!0,trim:!0},address:{street:String,city:String,state:String,zipCode:String,country:String},contact:{phone:String,email:String},location:{latitude:Number,longitude:Number,address:String},bankAccounts:[{accountTitle:String,serviceName:String,accountNo:String,iban:String,isDefault:{type:Boolean,default:!1}}],admin:{type:t.default.Schema.Types.ObjectId,ref:"User",default:null},status:{type:String,enum:["active","inactive"],default:"active"},settings:{type:Map,of:t.default.Schema.Types.Mixed,default:{}}},{timestamps:!0}),d=t.default.models.Branch||t.default.model("Branch",r);e.s(["default",0,d])},270406,(e,t,r)=>{t.exports=e.x("next/dist/compiled/@opentelemetry/api",()=>require("next/dist/compiled/@opentelemetry/api"))},193695,(e,t,r)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},926046,(e,t,r)=>{t.exports=e.x("mongoose",()=>require("mongoose"))},300794,(e,t,r)=>{t.exports=e.x("node:dns/promises",()=>require("node:dns/promises"))},87170,e=>{"use strict";var t=e.i(300794),r=e.i(926046);t.default.setServers(["8.8.8.8","8.8.4.4"]);let d=process.env.MONGODB_URI,a="true"!==process.env.ENABLE_REAL_DB||!d,o=e.g.mongoose;async function s(){if(a)return null;if(o.conn)return o.conn;o.promise||(o.promise=r.default.connect(d,{bufferCommands:!1}).then(e=>(console.log("✅ MongoDB connected successfully"),e)));try{o.conn=await o.promise}catch(e){throw o.promise=null,e}return o.conn}function i(){return a}o||(o=e.g.mongoose={conn:null,promise:null}),e.s(["default",0,s,"isMockMode",()=>i])},254799,(e,t,r)=>{t.exports=e.x("crypto",()=>require("crypto"))},688947,(e,t,r)=>{t.exports=e.x("stream",()=>require("stream"))},500874,(e,t,r)=>{t.exports=e.x("buffer",()=>require("buffer"))},446786,(e,t,r)=>{t.exports=e.x("os",()=>require("os"))},427699,(e,t,r)=>{t.exports=e.x("events",()=>require("events"))},814747,(e,t,r)=>{t.exports=e.x("path",()=>require("path"))},522734,(e,t,r)=>{t.exports=e.x("fs",()=>require("fs"))},792509,(e,t,r)=>{t.exports=e.x("url",()=>require("url"))},921517,(e,t,r)=>{t.exports=e.x("http",()=>require("http"))},524836,(e,t,r)=>{t.exports=e.x("https",()=>require("https"))},406461,(e,t,r)=>{t.exports=e.x("zlib",()=>require("zlib"))},504446,(e,t,r)=>{t.exports=e.x("net",()=>require("net"))},725677,e=>{"use strict";e.s(["getStudentEmailTemplate",0,(e,t,r="Ease Academy")=>{let d=`
  ...
  `;if("STUDENT_CREATED"===e)return`
    ...
    `;if("fee_voucher_generated"===e){let{voucherNumber:e,amount:l,dueDate:p,month:c,year:g,category:x,discountAmount:u,lateFeeAmount:h,totalAmount:y}=t;return`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="utf-8">
        ...
        <div style="${o}">
          ...
          <div style="${s}">
            ...
            <div style="${i}">
              ...
              <table style="width: 100%; font-size: 14px;">
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0;">${x||"Monthly Fee"}</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td style="padding: 8px 0; color: #27ae60;">- Rs. ${u?.toLocaleString()}</td>
                </tr>
                `:""}
                ${h>0?`
                <tr>
                  <td style="padding: 8px 0; font-weight: bold; color: #e74c3c;">Late Fee:</td>
                  <td style="padding: 8px 0; color: #e74c3c;">+ Rs. ${h?.toLocaleString()}</td>
                </tr>
                `:""}
                <tr style="border-top: 2px solid #667eea;">
                  <td style="padding: 12px 0; font-weight: bold; font-size: 16px;">Total Amount:</td>
                  <td style="padding: 12px 0; font-weight: bold; font-size: 16px; color: #667eea;">Rs. ${y?.toLocaleString()}</td>
                </tr>
                <tr>
            ...
            <div style="background: #fff3cd; padding: 15px; border-radius: 4px; margin: 20px 0; border-left: 4px solid #ffc107;">
              ...
              <p style="margin: 5px 0 0 0; color: #856404;">A late fee of Rs. ${h?.toLocaleString()} has been added due to previous unpaid fees.</p>
            </div>
            `:""}
    ...
    `}if("exam_scheduled"===e){let{studentName:e,examTitle:r,examType:l,examDate:p,subjectNames:c,className:g,schoolName:x}=t;return`
      <!DOCTYPE html>
      <html>
      <head>
        <meta charset="UTF-8">
      ...
      <body>
        <div class="container">
          <div class="header">
            <h2 style="margin: 0; font-size: 28px;">📚 ${x}</h2>
          ...
          <div class="content">
            ...
            <p style="margin: 20px 0 0 0;">Best regards,<br><strong>${x} Administration</strong></p>
          </div>

          <div class="footer">
            <p style="margin: 0;">This is an automated email. Please do not reply to this message.</p>
            <p style="margin: 5px 0 0 0;">&copy; ${new Date().getFullYear()} ${x}. All rights reserved.</p>
          </div>
        </div>
      </body>
      </html>
    `}return"<html><body><p>Hello,</p><p>Student record updated.</p></body></html>"}])},865622,e=>{e.v(e=>Promise.resolve().then(()=>e(356780)))},365099,e=>{e.v(e=>Promise.resolve().then(()=>e(518041)))},495510,e=>{e.v(t=>Promise.all(["server/chunks/[root-of-the-server]__e4e0f6d3._.js","server/chunks/node_modules_7cac5bcb._.js"].map(t=>e.l(t))).then(()=>t(285465)))}];

//# sourceMappingURL=%5Broot-of-the-server%5D__6d85a224._.js.map