...
const getFullUrl = (endpoint)=>{
    ...
    const baseUrl = API_CONFIG.BASE_URL || (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : '');
    return `${baseUrl}${endpoint}`;
};
const __TURBOPACK__default__export__ = API_ENDPOINTS;
}),
"[project]/src/lib/mock-data.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/mock-data.js [app-ssr] (ecmascript)");
;
;
;
/**
...
const MOCK_FEE_VOUCHERS = [
    {
        ...
        branchId: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BRANCH"]._id
    },
    {
        _id: 'mock-voucher-2',
...
const MOCK_BRANCHES = [
    {
        _id: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BRANCH"]._id,
        name: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BRANCH"].name,
        code: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BRANCH"].code,
        status: 'active',
        totalStudents: 100,
        totalTeachers: 10
    }
...
function decodeTokenPayload(token) {
    ...
    try {
        ...
        const json = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : Buffer.from(payloadPart, 'base64').toString('utf8');
...
function getMockAuthUser() {
    const token = getAccessToken() || (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : null);
    const payload = decodeTokenPayload(token);
    if (payload?.userId) {
        const directUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockUserById"])(payload.userId);
        if (directUser) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSafeMockUser"])(directUser);
        }
    }
    return null;
}
function getMockStudents() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockUsers"])().filter((user)=>user.role === 'student').map((user, index)=>({
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSafeMockUser"])(user),
            studentProfile: {
...
function getMockTeachers() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockUsers"])().filter((user)=>user.role === 'teacher').map((user)=>({
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSafeMockUser"])(user),
...
function getMockParents() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockUsers"])().filter((user)=>user.role === 'parent').map((user)=>({
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSafeMockUser"])(user),
            status: 'active'
        }));
}
function getMockStaff() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockUsers"])().filter((user)=>user.role === 'staff').map((user)=>({
            ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSafeMockUser"])(user),
            status: 'active'
        }));
}
function getMockClasses() {
    return MOCK_CLASSES.map((classItem)=>({
            ...classItem,
            branchName: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_BRANCH"].name,
...
async function buildMockResponse(method, endpoint, data = null) {
    ...
    if (normalizedEndpoint === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2d$endpoints$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.LOGIN && upperMethod === 'POST') {
        const email = data?.email;
        const password = data?.password;
        const mockUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockUserByEmail"])(email);
        ...
        const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSafeMockUser"])(mockUser);
        const encodedPayload = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : Buffer.from(JSON.stringify({
            userId: user._id,
            role: user.role,
            email: user.email,
            branchId: user.branchId
    ...
    if (normalizedEndpoint === __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2f$api$2d$endpoints$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ENDPOINTS"].AUTH.ME && upperMethod === 'GET') {
    ...
    if (normalizedEndpoint.includes('/super-admin/dashboard/stats')) {
        return createMockPayload((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockSuperAdminDashboardStats"])());
    }
    if (normalizedEndpoint.includes('/branch-admin/dashboard')) {
        return createMockPayload((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockBranchAdminDashboard"])());
    }
    if (normalizedEndpoint.includes('/teacher/my-classes')) {
        return createMockCollection((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockTeacherClasses"])(), 'classes');
    }
    ...
    if (normalizedEndpoint.includes('/users')) {
        return createMockCollection((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockUsers"])().map((user)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toSafeMockUser"])(user)), 'users');
    }
    if (normalizedEndpoint.includes('/teacher/dashboard')) {
        return createMockPayload({
            ...
            myClasses: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getMockTeacherClasses"])(),
            todaySchedule: [
                {
                    time: '08:00 AM',
                    class: 'Class 10A',
 ...
 */ class ApiClient {
   ...
   */ async request(method, endpoint, data = null, config = {}) {
        this.loading = true;
        try {
            if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isMockModeEnabled"])()) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__823effad._.js.map