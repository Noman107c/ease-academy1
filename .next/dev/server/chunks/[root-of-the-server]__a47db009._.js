...
"[project]/src/app/api/super-admin/charts/monthly-fee-collection/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        // Authenticate user
        const authResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$middleware$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["authenticate"])(request);
        if (authResult.error) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
        ...
        const approvedPipeline = [
            // Match fee vouchers with approved payments
            {
                $match: {
                    ...
                    ...branch !== 'all' && {
                        branchId: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Types.ObjectId(branch)
                    }
                }
            },
            ...
            // Group by month and year
            {
                $group: {
                    _id: {
                        year: {
                            $year: '$paymentHistory.paymentDate'
                        },
                        month: {
                            $month: '$paymentHistory.paymentDate'
                        }
                    },
                    approvedAmount: {
        ...
        const [approvedData, pendingData] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$FeeVoucher$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate(approvedPipeline),
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$FeeVoucher$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate(pendingPipeline)
        ]);
        // Debug logging
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a47db009._.js.map