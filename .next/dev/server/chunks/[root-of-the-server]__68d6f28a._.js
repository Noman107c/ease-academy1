...
"[project]/src/app/api/branch-admin/charts/monthly-fee-collection/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (filter === 'weekly') {
            ...
            for(let i = periods - 1; i >= 0; i--){
                ...
                const dayMonth = dayStart.toLocaleString('default', {
                    month: 'short'
                });
                const dayDate = dayStart.getDate();
                const label = `${dayMonth} ${dayDate}`;
                // Get collected fees for this day
                const collectedResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$FeeVoucher$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
                    {
                        $match: {
                            branchId: branchId,
                            status: 'paid',
                ...
                const pendingResult = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$FeeVoucher$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
                    {
                        $match: {
                            branchId: branchId,
                            status: {
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$middleware$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(getMonthlyFeeCollection);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__68d6f28a._.js.map