...
"[project]/src/app/api/branch-admin/charts/pass-fail-ratio/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getPassFailRatio(request, authenticatedUser, userDoc) {
    try {
        ...
        for(let i = 5; i >= 0; i--){
            ...
            const totalGrades = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$Grade$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                branchId: branchId,
                createdAt: {
                    $gte: monthStart,
                    $lte: monthEnd
            ...
            const passingGrades = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$Grade$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                branchId: branchId,
                grade: {
                    $gte: 50
                },
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$middleware$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(getPassFailRatio);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__367399ae._.js.map