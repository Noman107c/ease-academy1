...
"[project]/src/app/api/branch-admin/charts/class-wise-students/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getClassWiseStudents(request, authenticatedUser, userDoc) {
    try {
        ...
        const classData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$Class$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    branchId: branchId
                }
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$middleware$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(getClassWiseStudents);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__5e20b2e1._.js.map