...
"[project]/src/app/api/branch-admin/dashboard/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getDashboard(request, authenticatedUser, userDoc) {
    try {
        ...
        if (authenticatedUser.role !== 'branch_admin') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                message: 'Access denied. Branch admin role required.'
            }, {
                status: 403
            });
        }
        ...
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$database$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isMockMode"])()) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                data: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mock$2d$data$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getMockBranchAdminDashboard"])(),
        ...
        const [totalStudents, activeStudents, totalTeachers, activeTeachers, totalClasses, totalSubjects, recentEvents, studentsThisMonth, teachersThisMonth] = await Promise.all([
            // Total students in branch
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$User$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                role: 'student',
                branchId
            }),
            // Active students
            ...
            // Total classes
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$Class$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                branchId
            }),
            // Total subjects
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$Subject$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].countDocuments({
                classId: {
                    $exists: true
                }
            }),
            // Recent events (next 7 days)
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$Event$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({
                $or: [
                    {
                        branchId
                    },
        ...
        const classDistribution = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$models$2f$Class$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    branchId: branchId
                }
...
const GET = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$backend$2f$middleware$2f$auth$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["withAuth"])(getDashboard);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__34f7b147._.js.map